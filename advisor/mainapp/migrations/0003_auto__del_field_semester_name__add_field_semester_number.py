...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'mainapp_semester', 'name')

        # Adding field 'Semester.number'
        db.add_column(u'mainapp_semester', 'number',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'mainapp_semester', 'name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50),
                      keep_default=False)

        # Deleting field 'Semester.number'
        db.delete_column(u'mainapp_semester', 'number')
