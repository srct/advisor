...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.advisorname'
        db.alter_column(u'mainapp_student', 'advisorname_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mainapp.AdvisorAdminUser'], unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Student.advisorname'
        raise RuntimeError("Cannot reverse this migration. 'Student.advisorname' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Student.advisorname'
        db.alter_column(u'mainapp_student', 'advisorname_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mainapp.AdvisorAdminUser'], unique=True))
