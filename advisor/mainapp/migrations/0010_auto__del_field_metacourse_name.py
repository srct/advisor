...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MetaCourse.name'
        db.delete_column(u'mainapp_metacourse', 'name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MetaCourse.name'
        raise RuntimeError("Cannot reverse this migration. 'MetaCourse.name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'MetaCourse.name'
        db.add_column(u'mainapp_metacourse', 'name',
