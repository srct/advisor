...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mainapp_requirement', 'catalogyear',
                      self.gf('django.db.models.fields.IntegerField')(default=20132014),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Requirement.catalogyear'
        db.delete_column(u'mainapp_requirement', 'catalogyear')
