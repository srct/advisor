...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mainapp_student', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), null=True, populate_from='user'))

    def backwards(self, orm):

        # Changing field 'Student.slug'
        db.alter_column(u'mainapp_student', 'slug', self.gf('autoslug.fields.AutoSlugField')(populate_from='name', unique_with=(), max_length=50, null=True))
