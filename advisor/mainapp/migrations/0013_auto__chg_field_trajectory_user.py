...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mainapp_trajectory', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['mainapp.Student']))

    def backwards(self, orm):

        # Changing field 'Trajectory.user'
        db.alter_column(u'mainapp_trajectory', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'mainapp.semester': {
            ...
            'programs': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'progs+'", 'symmetrical': 'False', 'to': u"orm['mainapp.Program']"}),
        ...
        u'mainapp.trajectory': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'trajectory-user'", 'unique': 'True', 'to': u"orm['mainapp.Student']"})
        }
    }
