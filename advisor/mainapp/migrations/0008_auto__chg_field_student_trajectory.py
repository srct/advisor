...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.trajectory'
        db.alter_column(u'mainapp_student', 'trajectory_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mainapp.Trajectory'], unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Student.trajectory'
        raise RuntimeError("Cannot reverse this migration. 'Student.trajectory' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Student.trajectory'
        db.alter_column(u'mainapp_student', 'trajectory_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mainapp.Trajectory'], unique=True))
