...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetaCourse.name'
        db.alter_column(u'mainapp_metacourse', 'name', self.gf('django.db.models.fields.CharField')(default='a', max_length=50))

    def backwards(self, orm):

        # Changing field 'MetaCourse.name'
        db.alter_column(u'mainapp_metacourse', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
