...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Major.concentration'
        db.delete_column(u'mainapp_major', 'concentration_id')

        # Adding M2M table for field concentrations on 'Major'
        m2m_table_name = db.shorten_name(u'mainapp_major_concentrations')
        ...
        db.create_unique(m2m_table_name, ['major_id', 'concentration_id'])


        # Changing field 'Major.gened'
        db.alter_column(u'mainapp_major', 'gened_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.GenEd'], null=True))
        # Adding field 'Concentration.associatedmajors'
        db.add_column(u'mainapp_concentration', 'associatedmajors',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Major'], null=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Major.concentration'
        raise RuntimeError("Cannot reverse this migration. 'Major.concentration' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Major.concentration'
        db.add_column(u'mainapp_major', 'concentration',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Concentration'], blank=True),
                      keep_default=False)

        # Removing M2M table for field concentrations on 'Major'
        db.delete_table(db.shorten_name(u'mainapp_major_concentrations'))


        # User chose to not deal with backwards NULL issues for 'Major.gened'
        raise RuntimeError("Cannot reverse this migration. 'Major.gened' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Major.gened'
        db.alter_column(u'mainapp_major', 'gened_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.GenEd']))
        # Deleting field 'Concentration.associatedmajors'
        db.delete_column(u'mainapp_concentration', 'associatedmajors_id')
    ...
    models = {
        ...
        u'mainapp.concentration': {
            ...
            'associatedmajors': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mainapp.Major']", 'null': 'True'}),
        ...
        u'mainapp.major': {
            ...
            'concentrations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['mainapp.Concentration']", 'null': 'True', 'blank': 'True'}),
            'gened': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mainapp.GenEd']", 'null': 'True', 'blank': 'True'}),
            u'program_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['mainapp.Program']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        u'mainapp.student': {
            ...
            'advisorname': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['mainapp.AdvisorAdminUser']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'coursestaken': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['mainapp.Course']", 'null': 'True', 'blank': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'dateOfGrad': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'programs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['mainapp.Program']", 'symmetrical': 'False'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'unique_with': '()', 'null': 'True', 'populate_from': "'user'"}),
            'trajectory': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['mainapp.Trajectory']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
