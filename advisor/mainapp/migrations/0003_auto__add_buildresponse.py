...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BuildResponse'
        db.create_table(u'mainapp_buildresponse', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('semester', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainapp.Semester'])),
        ))
        db.send_create_signal(u'mainapp', ['BuildResponse'])

        # Adding M2M table for field programs on 'BuildResponse'
        m2m_table_name = db.shorten_name(u'mainapp_buildresponse_programs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('buildresponse', models.ForeignKey(orm[u'mainapp.buildresponse'], null=False)),
            ('program', models.ForeignKey(orm[u'mainapp.program'], null=False))
        ))
        db.create_unique(m2m_table_name, ['buildresponse_id', 'program_id'])


    def backwards(self, orm):
        # Deleting model 'BuildResponse'
        db.delete_table(u'mainapp_buildresponse')

        # Removing M2M table for field programs on 'BuildResponse'
        db.delete_table(db.shorten_name(u'mainapp_buildresponse_programs'))
